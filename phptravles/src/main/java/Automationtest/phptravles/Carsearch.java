...
public class Carsearch extends Launch {
	    ...
	    driver.findElement(picup_loction1).sendKeys(prop.getProperty("cars1"));
		 // Thread.sleep(1000);
		...
		else
		{
		 ...
		 if(text.equals(prop.getProperty("drop_month")))
		 {
		  break;
		 }
		 else
		 ...
		 driver.findElement(By.xpath("//div[13]//div[1]//tr[1]//th[3]")).click();
		  ...
		  driver.findElement(By.xpath("//div[13]//tr//td[contains(text(),"+prop.getProperty("dropday")+")]")).click(); 
		//pick_time
